...
- **SS Ratio has two variants in `lib/metrics.cjs` — they answer different questions, don't merge them:**
  ...
  - The compose SS Ratio card only colours amber on a **sustained** breach (this week and last week both >1.0); one elevated week is usually just the Fri/Sat rhythm
