...
## Resource page (added 2026-08-25)
...
- **Build-vs-buy is quoted as a BREAK-EVEN, not a rate.** Cost per in-house
  ...
  $390, a sevenfold flattery on the same page whose first line says only 14% of
  that capacity is realised. Break-even (4.4/wk/surveyor) is the one figure
  that does not depend on the capacity model being right. The panel also prints
  where they actually are — $841/survey at 2.0/wk, **above** the vendor
...
- **The team table's last column is not a personal workload.** SF records the
  *resource*, never which surveyor, so in-house work can only be attributed to
