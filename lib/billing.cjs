...
(function (root, factory) {
  ...
  const EXCEPTIONS = [
    ...
    { k: 'epc_account', label: 'External EPC account', sev: SEVERITY.INFO,
      why: 'Matched to a project sold through an external EPC rather than to the survey export. Real work we were billed for; it carries cost but no survey resource or dates, so it cannot contribute to cycle time or first pass yield.' },
  ...
  function reconcile(lines, surveyRows, epcRows) {
