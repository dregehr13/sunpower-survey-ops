...
(function (root, factory) {
  ...
  // completed rows needs the stricter test. Parked lists ('Inactive' /
  // 'Not Required') are out for the same reason isWIP drops them.
  const isOpenResurvey = r => !!(r.resurvey_requested && !r.resurvey_complete && r.list !== 'Complete' && !PARKED_LIST(r));
