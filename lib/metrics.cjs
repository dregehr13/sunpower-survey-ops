...
(function (root, factory) {
  ...
  // neither active work nor a finished survey — it is out of scope unless the
  // survey genuinely completed (List 'Complete', handled above).
  ...
  function projectWeek(allRows, weekStartISO, asOfISO, opts) {
    ...
    const _schedToday = r => r.scheduled === asOfISO || r.resurvey_scheduled === asOfISO;
